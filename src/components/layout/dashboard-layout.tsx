  ...
  const cats: NavCat[] = [
    {
      ...
      tabs: [
        ...
        { href: "/dashboard/marktplaats", icon: "🏪", label: "Marktplaats" },
    ...
    },
    {
      ...
      tabs: [
        ...
        { href: "/dashboard/abonnementen", icon: "💳", label: "Abonnementen" },
    ...
    },
    {
      ...
      tabs: [
        ...
        { href: "/dashboard/goedkeuringen", icon: "✅", label: "Goedkeuringen" },
